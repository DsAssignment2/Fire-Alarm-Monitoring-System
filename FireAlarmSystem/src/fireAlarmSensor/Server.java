...
/*** RMI server to call APIs to create connection between desktop client and rest API ***/
...
//    
    ...
    public void ApiJSONCalls() throws ParseException {
...
/*******************************AllSensorDetails JSON *******************************************/  
        ...
        if (AllRetrieveSensorDetails != null) {
          try {
                ...
                //System.out.println("After clear:"+fetchAllSensorDetailsList);

                for (Object object : jsonArray) {
                 //System.out.println("Object :"+object);
                    JSONObject jsonObject = (JSONObject) object;
                  
                    fetchAllSensorDetailsList.add(
                            new AllSensorDetails(
                   ...
                   for(AllSensorDetails sensor : fetchAllSensorDetailsList){
